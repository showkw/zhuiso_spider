...
EXTENSIONS = {
    ...
    'core.extensions.RedisSpiderSmartIdleClosedExensions': 500,
}
...
ITEM_PIPELINES = {
    # 'core.corePipelines.MySQLPipeline': 1,
}
...
REDIS_URL = 'redis://root:' + REDIS_CONFIG['default']['pass'] + '@' + REDIS_CONFIG['default']['host'] + ':' + \
            REDIS_CONFIG['default']['port']
